...
.btn:hover{
    background: #2381AE; /* For browsers that do not support gradients */
    background: -webkit-linear-gradient(#2682AF,#197BAB,#0972A5, #0972A5); /* For Safari 5.1 to 6.0 */
    background: -o-linear-gradient(#2682AF,#197BAB,#0972A5, #0972A5); /* For Opera 11.1 to 12.0 */
    background: -moz-linear-gradient(#2682AF,#197BAB,#0972A5, #0972A5); /* For Firefox 3.6 to 15 */
    background: linear-gradient(#2682AF,#197BAB,#0972A5, #0972A5); /* Standard syntax */
...
<div class="sign_in">
	...
	<div class="center-div">
		...
		<br>
        <span class="b red"><?php echo $_GET['details']; ?></span>
        <br>
        <input type="text" value="<?php if ($_GET['uid']<>''){echo trim($_GET['uid']);}?>" name="id" placeholder="Enter your username" autofocus>
		<br>
        <input type="password" value="<?php if ($_GET['pwd']<>''){echo trim($_GET['pwd']);}?>"name="password" placeholder="Enter your password">
		<br>
